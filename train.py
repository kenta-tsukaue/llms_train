...
from transformers import AutoModelForCausalLM, AutoTokenizer, TrainingArgument
...
def train():
    ...
    model = AutoModelForCausalLM.from_pretrained(
        "Salesforce/xgen-7b-8k-base", load_in_4bit=True, torch_dtype=torch.float16, device_dtype=torch.float16, device_map="auto"
    )
